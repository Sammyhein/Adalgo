...
import {myIncludes, myIndexOf,myStartsWith, myRepeat, myJoin, myObjectKeys, myObjectEntries} from "../functions/09-myJs";
...
suite("myJs", () => {
    ...
    test("myIndexOf", () => {
        ...
        expect(myIndexOf(["1", "2", "3"], "2")).toBe(1);
    });
    ...
    test("myObjectEntries", () => {
        expect(myObjectEntries({a: 1, b: 2})).toStrictEqual([['a', 1], ['b', 2]]);
    });
});